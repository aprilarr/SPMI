<?php
/**
    @class StandarPembiayaanController
    @extends BaseController
    @description pembiayaan Controller
*/
namespace Controllers;

class StandarPembiayaanController extends \System\BaseController
{
    public function index()	
    {    
        // set judul halaman
        $this->viewBag->pageTitle="Standar Pembiayaan";      
        
        $datapemetaan = new \Models\SPMIModel(); 
        $listdatapemetaan = $datapemetaan->getPemetaanMutu(8);
    ...
    public function getIndikator()
    {
        ...
        $listdataindikator = $dataindikator->getIndikatorByIdStandarAjax(8);
