<?php
/**
    @class StandarTendikController
    @extends BaseController
    @description tendik Controller
*/
namespace Controllers;

class StandarTendikController extends \System\BaseController
{
    public function index()	
    {    
        // set judul halaman
        $this->viewBag->pageTitle="Standar Pendidik dan Tenaga Kependidikan";      
        
        $datapemetaan = new \Models\SPMIModel(); 
        $listdatapemetaan = $datapemetaan->getPemetaanMutu(5);
    ...
    public function getIndikator()
    {
        ...
        $listdataindikator = $dataindikator->getIndikatorByIdStandarAjax(5);
