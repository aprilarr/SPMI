<?php
/**
    @class StandarSaprasController
    @extends BaseController
    @description sapras Controller
*/
namespace Controllers;

class StandarSaprasController extends \System\BaseController
{
    public function index()	
    {    
        // set judul halaman
        $this->viewBag->pageTitle="Standar Sarana dan Prasarana";      
        
        $datapemetaan = new \Models\SPMIModel(); 
        $listdatapemetaan = $datapemetaan->getPemetaanMutu(6);
    ...
    public function getIndikator()
    {
        ...
        $listdataindikator = $dataindikator->getIndikatorByIdStandarAjax(6);
