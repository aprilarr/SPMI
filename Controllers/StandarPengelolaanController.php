<?php
/**
    @class StandarPengelolaanController
    @extends BaseController
    @description pengelolaan Controller
*/
namespace Controllers;

class StandarPengelolaanController extends \System\BaseController
{
    public function index()	
    {    
        // set judul halaman
        $this->viewBag->pageTitle="Standar Pengelolaan";      
        
        $datapemetaan = new \Models\SPMIModel(); 
        $listdatapemetaan = $datapemetaan->getPemetaanMutu(7);
    ...
    public function getIndikator()
    {
        ...
        $listdataindikator = $dataindikator->getIndikatorByIdStandarAjax(7);
