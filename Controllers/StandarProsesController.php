<?php
/**
    @class StandarProsesController
    @extends BaseController
    @description proses Controller
*/
namespace Controllers;

class StandarProsesController extends \System\BaseController
{
    public function index()	
    {    
        // set judul halaman
        $this->viewBag->pageTitle="Standar Proses";      
        
        $datapemetaan = new \Models\SPMIModel(); 
        $listdatapemetaan = $datapemetaan->getPemetaanMutu(3);
    ...
    public function getIndikator()
    {
        ...
        $listdataindikator = $dataindikator->getIndikatorByIdStandarAjax(3);
