<?php
/**
    @class StandarIsiController
    @extends BaseController
    @description tendik Controller
*/
namespace Controllers;

class StandarIsiController extends \System\BaseController
{
    public function index()	
    {    
        // set judul halaman
        $this->viewBag->pageTitle="Standar Isi";      
        
        $datapemetaan = new \Models\SPMIModel(); 
        $listdatapemetaan = $datapemetaan->getPemetaanMutu(2);
    ...
    public function getIndikator()
    {
        ...
        $listdataindikator = $dataindikator->getIndikatorByIdStandarAjax(2);
