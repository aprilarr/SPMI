...
// authorization
define("AUTH_NOT_AUTHORIZED", "You are not authorized");

// page error
define("PAGE_NOT_FOUND", "Sorry, Page Not Found");
define("PAGE_BAD_REQUEST", "Sorry, We cannot process your request");