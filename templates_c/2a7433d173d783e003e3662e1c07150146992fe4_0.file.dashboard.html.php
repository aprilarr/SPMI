<?php
/* Smarty version 3.1.32, created on 2019-11-03 10:02:37
  from 'E:\Novi Lagi Belajar\bantingan\bantingan\Views\Home\dashboard.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5dbe434d392489_90344295',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2a7433d173d783e003e3662e1c07150146992fe4' => 
    array (
      0 => 'E:\\Novi Lagi Belajar\\bantingan\\bantingan\\Views\\Home\\dashboard.html',
      1 => 1572750150,
      2 => 'file',
    ),
  ),
...
function content_5dbe434d392489_90344295 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_242265dbe434d376629_43986355', 'bodycontent');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "../Shared/core2.master.html");
}
/* {block 'bodycontent'} */
class Block_242265dbe434d376629_43986355 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'bodycontent' => 
  array (
    0 => 'Block_242265dbe434d376629_43986355',
  ),
);
...
/assets/vendor/coreui2/#">Action</a>
                <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/assets/vendor/coreui2/#">Another action</a>
                <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/assets/vendor/coreui2/#">Something else here</a>
              </div>
            </div>
...
/assets/vendor/coreui2/img/avatars/1.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/assets/vendor/coreui2/img/flags/USA.png" alt="USA" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
...
/assets/vendor/coreui2/img/avatars/2.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/assets/vendor/coreui2/img/flags/Brazil.png" alt="Brazil" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
...
/assets/vendor/coreui2/img/avatars/3.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/assets/vendor/coreui2/img/flags/India.png" alt="India" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
...
/assets/vendor/coreui2/img/avatars/4.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/assets/vendor/coreui2/img/flags/France.png" alt="France" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
...
/assets/vendor/coreui2/img/avatars/5.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/assets/vendor/coreui2/img/flags/Spain.png" alt="Spain" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
...
/assets/vendor/coreui2/img/avatars/6.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/assets/vendor/coreui2/img/flags/Poland.png" alt="Poland" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
